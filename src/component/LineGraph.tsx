  ...
  return (
    <Card className="w-full h-full">
      <CardHeader className="items-center pb-4">
        <CardTitle className="text-center text-slate-300">Line Chart - Data Points Visualization</CardTitle>
      </CardHeader>
        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              {/* Line graph */}
              <Line type="monotone" dataKey="y" stroke="hsl(var(--chart-1))" dot={true} />
            </LineChart>
          </ResponsiveContainer>
        </ChartContainer>
      </CardContent>
